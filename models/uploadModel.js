    ...
    media_audience_maturity: [
      {
        ...
        enum: {
          values: [
            'No-mature-content',
            'mature moderate nudity',
            'mature moderate sexual-themes',
            'mature moderate violence-or-gore',
            'mature moderate strong-language',
            'mature moderate ideologically sensitive',
            'mature strict nudity',
            'mature strict sexual-themes',
            'mature strict sexually-explicit-themes',
            'mature strict violence-or-gore',
            'mature strict strong-language',
            'mature strict ideologically-sensitive',
          ],
